...
import Last from './components/last_checkout';
import Stock from './components/stock_warning';
function App() {
 return (
    <div>
            ...
            <div className="container-fluid mb-5">
              ...
              <div className="row ml-md-2">
                  ...
                  <div className="col-lg-6">
                    <BillingCard title="Create order" content="Start a new billing" />
                  </div>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <Today title="Revenue" amount="Rs. 456"></Today>
                  </div>
                  <div className="col-lg-4 col-md-6 mt-3 mt-md-0">
                    <Today title="Customers" amount="Rs. 56"></Today>
                  </div>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <Stock medicine="Paracetamol" company="Company name" units="2 units left" distributor="Iswar Drug Distributer"></Stock>
                  </div>
                  <div className="col-lg-4 col-md-6 mt-3 mt-md-0">
                  ...
                  <div className="col-12 mt-5">
                    ...
                    <div className="col-lg-4 col-md-6">
                      <Last name="Revenue" amount="Rs. 456" timestamp="09:00am"></Last>
                    </div>
                    <div className="col-lg-4 col-md-6 mt-3 mt-md-0">
                      <Last name="Profit" amount="Rs. 456" timestamp="09:00am"></Last>
                    </div>
                    <div className="col-lg-4 mt-3 mt-lg-0">
